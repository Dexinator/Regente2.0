...
DROP EVENT TRIGGER IF EXISTS validate_extension;
DROP EVENT TRIGGER IF EXISTS log_drop_ext;
DROP EVENT TRIGGER IF EXISTS log_create_ext;
DROP EVENT TRIGGER IF EXISTS extension_before_drop;
ALTER TABLE IF EXISTS ONLY public.sabores DROP CONSTRAINT IF EXISTS sabores_categoria_id_fkey;
ALTER TABLE IF EXISTS ONLY public.requisiciones DROP CONSTRAINT IF EXISTS requisiciones_usuario_id_fkey;
ALTER TABLE IF EXISTS ONLY public.productos_sentencias DROP CONSTRAINT IF EXISTS productos_sentencias_tamano_id_fkey;
ALTER TABLE IF EXISTS ONLY public.productos_sentencias DROP CONSTRAINT IF EXISTS productos_sentencias_sentencia_id_fkey;
ALTER TABLE IF EXISTS ONLY public.productos_sentencias DROP CONSTRAINT IF EXISTS productos_sentencias_sabor_id_fkey;
ALTER TABLE IF EXISTS ONLY public.productos_sentencias DROP CONSTRAINT IF EXISTS productos_sentencias_producto_id_fkey;
ALTER TABLE IF EXISTS ONLY public.productos_sentencias DROP CONSTRAINT IF EXISTS productos_sentencias_ingrediente_id_fkey;
ALTER TABLE IF EXISTS ONLY public.producto_sabor DROP CONSTRAINT IF EXISTS producto_sabor_sabor_id_fkey;
ALTER TABLE IF EXISTS ONLY public.producto_sabor DROP CONSTRAINT IF EXISTS producto_sabor_producto_id_fkey;
ALTER TABLE IF EXISTS ONLY public.preso_grado DROP CONSTRAINT IF EXISTS preso_grado_preso_id_fkey;
ALTER TABLE IF EXISTS ONLY public.preso_grado DROP CONSTRAINT IF EXISTS preso_grado_grado_id_fkey;
ALTER TABLE IF EXISTS ONLY public.pagos DROP CONSTRAINT IF EXISTS pagos_orden_id_fkey;
ALTER TABLE IF EXISTS ONLY public.pagos DROP CONSTRAINT IF EXISTS pagos_empleado_id_fkey;
ALTER TABLE IF EXISTS ONLY public.ordenes DROP CONSTRAINT IF EXISTS ordenes_preso_id_fkey;
ALTER TABLE IF EXISTS ONLY public.ordenes DROP CONSTRAINT IF EXISTS ordenes_empleado_id_fkey;
ALTER TABLE IF EXISTS ONLY public.ordenes DROP CONSTRAINT IF EXISTS ordenes_codigo_descuento_id_fkey;
ALTER TABLE IF EXISTS ONLY public.items_requisicion DROP CONSTRAINT IF EXISTS items_requisicion_requisicion_id_fkey;
ALTER TABLE IF EXISTS ONLY public.items_requisicion DROP CONSTRAINT IF EXISTS items_requisicion_insumo_id_fkey;
ALTER TABLE IF EXISTS ONLY public.items_compra DROP CONSTRAINT IF EXISTS items_compra_requisicion_item_id_fkey;
ALTER TABLE IF EXISTS ONLY public.items_compra DROP CONSTRAINT IF EXISTS items_compra_insumo_id_fkey;
ALTER TABLE IF EXISTS ONLY public.items_compra DROP CONSTRAINT IF EXISTS items_compra_compra_id_fkey;
ALTER TABLE IF EXISTS ONLY public.inventario DROP CONSTRAINT IF EXISTS inventario_insumo_id_fkey;
ALTER TABLE IF EXISTS ONLY public.insumo_proveedor DROP CONSTRAINT IF EXISTS insumo_proveedor_proveedor_id_fkey;
ALTER TABLE IF EXISTS ONLY public.insumo_proveedor DROP CONSTRAINT IF EXISTS insumo_proveedor_insumo_id_fkey;
ALTER TABLE IF EXISTS ONLY public.detalles_orden DROP CONSTRAINT IF EXISTS fk_detalles_orden_sentencia_padre;
ALTER TABLE IF EXISTS ONLY public.detalles_orden DROP CONSTRAINT IF EXISTS fk_detalles_orden_sentencia;
ALTER TABLE IF EXISTS ONLY public.detalles_orden DROP CONSTRAINT IF EXISTS detalles_orden_tamano_id_fkey;
ALTER TABLE IF EXISTS ONLY public.detalles_orden DROP CONSTRAINT IF EXISTS detalles_orden_sabor_id_fkey;
ALTER TABLE IF EXISTS ONLY public.detalles_orden DROP CONSTRAINT IF EXISTS detalles_orden_producto_id_fkey;
ALTER TABLE IF EXISTS ONLY public.detalles_orden DROP CONSTRAINT IF EXISTS detalles_orden_orden_id_fkey;
ALTER TABLE IF EXISTS ONLY public.detalles_orden DROP CONSTRAINT IF EXISTS detalles_orden_ingrediente_id_fkey;
ALTER TABLE IF EXISTS ONLY public.detalles_orden DROP CONSTRAINT IF EXISTS detalles_orden_empleado_id_fkey;
...
DROP TRIGGER IF EXISTS trigger_actualizar_requisicion ON public.items_compra;
DROP TRIGGER IF EXISTS trigger_actualizar_inventario ON public.inventario;
DROP INDEX IF EXISTS public.proveedores_rfc_unique;
DROP INDEX IF EXISTS public.inventario_insumo_id_unidad_key;
DROP INDEX IF EXISTS public.idx_sentencias_activa;
DROP INDEX IF EXISTS public.idx_requisiciones_usuario;
DROP INDEX IF EXISTS public.idx_requisiciones_completada;
DROP INDEX IF EXISTS public.idx_proveedores_rfc;
DROP INDEX IF EXISTS public.idx_proveedores_nombre;
DROP INDEX IF EXISTS public.idx_productos_sentencias_sentencia_id;
DROP INDEX IF EXISTS public.idx_ordenes_codigo_descuento_id;
DROP INDEX IF EXISTS public.idx_items_req_requisicion;
DROP INDEX IF EXISTS public.idx_items_req_insumo;
DROP INDEX IF EXISTS public.idx_items_compra_req_item;
DROP INDEX IF EXISTS public.idx_items_compra_insumo;
DROP INDEX IF EXISTS public.idx_items_compra_compra;
DROP INDEX IF EXISTS public.idx_insumos_nombre;
DROP INDEX IF EXISTS public.idx_insumos_categoria;
DROP INDEX IF EXISTS public.idx_compras_usuario;
DROP INDEX IF EXISTS public.idx_compras_proveedor;
DROP INDEX IF EXISTS public.idx_compras_fecha;
DROP INDEX IF EXISTS public.idx_codigos_promocionales_codigo;
ALTER TABLE IF EXISTS ONLY public.sentencias DROP CONSTRAINT IF EXISTS sentencias_pkey;
ALTER TABLE IF EXISTS ONLY public.sabores DROP CONSTRAINT IF EXISTS sabores_pkey;
ALTER TABLE IF EXISTS ONLY public.requisiciones DROP CONSTRAINT IF EXISTS requisiciones_pkey;
ALTER TABLE IF EXISTS ONLY public.proveedores DROP CONSTRAINT IF EXISTS proveedores_pkey;
ALTER TABLE IF EXISTS ONLY public.productos_sentencias DROP CONSTRAINT IF EXISTS productos_sentencias_sentencia_id_producto_id_sabor_id_tama_key;
ALTER TABLE IF EXISTS ONLY public.productos_sentencias DROP CONSTRAINT IF EXISTS productos_sentencias_pkey;
ALTER TABLE IF EXISTS ONLY public.productos DROP CONSTRAINT IF EXISTS productos_pkey;
ALTER TABLE IF EXISTS ONLY public.producto_sabor DROP CONSTRAINT IF EXISTS producto_sabor_producto_id_sabor_id_key;
ALTER TABLE IF EXISTS ONLY public.producto_sabor DROP CONSTRAINT IF EXISTS producto_sabor_pkey;
ALTER TABLE IF EXISTS ONLY public.presos DROP CONSTRAINT IF EXISTS presos_pkey;
ALTER TABLE IF EXISTS ONLY public.preso_grado DROP CONSTRAINT IF EXISTS preso_grado_pkey;
ALTER TABLE IF EXISTS ONLY public.pagos DROP CONSTRAINT IF EXISTS pagos_pkey;
ALTER TABLE IF EXISTS ONLY public.ordenes DROP CONSTRAINT IF EXISTS ordenes_pkey;
ALTER TABLE IF EXISTS ONLY public.items_requisicion DROP CONSTRAINT IF EXISTS items_requisicion_pkey;
ALTER TABLE IF EXISTS ONLY public.items_compra DROP CONSTRAINT IF EXISTS items_compra_pkey;
...
ALTER TABLE IF EXISTS ONLY public.insumos DROP CONSTRAINT IF EXISTS insumos_nombre_key;
ALTER TABLE IF EXISTS ONLY public.insumo_proveedor DROP CONSTRAINT IF EXISTS insumo_proveedor_pkey;
ALTER TABLE IF EXISTS ONLY public.insumo_proveedor DROP CONSTRAINT IF EXISTS insumo_proveedor_insumo_id_proveedor_id_key;
...
ALTER TABLE IF EXISTS ONLY public.empleados DROP CONSTRAINT IF EXISTS empleados_usuario_key;
...
ALTER TABLE IF EXISTS ONLY public.codigos_promocionales DROP CONSTRAINT IF EXISTS codigos_promocionales_codigo_key;
ALTER TABLE IF EXISTS ONLY public.categorias_variantes DROP CONSTRAINT IF EXISTS categorias_variantes_pkey;
ALTER TABLE IF EXISTS ONLY public.categoria_producto_tipo_variante DROP CONSTRAINT IF EXISTS categoria_producto_tipo_variante_pkey;
ALTER TABLE IF EXISTS ONLY public.categoria_producto_tipo_variante DROP CONSTRAINT IF EXISTS categoria_producto_tipo_varia_categoria_producto_tipo_varia_key;
ALTER TABLE IF EXISTS public.sentencias ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.sabores ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.requisiciones ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.proveedores ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.productos_sentencias ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.productos ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.producto_sabor ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.presos ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.preso_grado ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.pagos ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.ordenes ALTER COLUMN orden_id DROP DEFAULT;
ALTER TABLE IF EXISTS public.items_requisicion ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.items_compra ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.insumo_proveedor ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.grados ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.empleados ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.detalles_orden ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.compras ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.codigos_promocionales ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.categorias_variantes ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.categoria_producto_tipo_variante ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE IF EXISTS public.sentencias_id_seq;
DROP TABLE IF EXISTS public.sentencias;
DROP SEQUENCE IF EXISTS public.sabores_id_seq;
DROP TABLE IF EXISTS public.sabores;
DROP SEQUENCE IF EXISTS public.requisiciones_id_seq;
DROP TABLE IF EXISTS public.requisiciones;
DROP SEQUENCE IF EXISTS public.proveedores_id_seq;
DROP SEQUENCE IF EXISTS public.productos_sentencias_id_seq;
DROP TABLE IF EXISTS public.productos_sentencias;
DROP SEQUENCE IF EXISTS public.productos_id_seq;
DROP TABLE IF EXISTS public.productos;
DROP SEQUENCE IF EXISTS public.producto_sabor_id_seq;
DROP TABLE IF EXISTS public.producto_sabor;
DROP SEQUENCE IF EXISTS public.presos_id_seq;
DROP TABLE IF EXISTS public.presos;
DROP SEQUENCE IF EXISTS public.preso_grado_id_seq;
DROP TABLE IF EXISTS public.preso_grado;
DROP SEQUENCE IF EXISTS public.pagos_id_seq;
DROP TABLE IF EXISTS public.pagos;
DROP SEQUENCE IF EXISTS public.ordenes_orden_id_seq;
DROP TABLE IF EXISTS public.ordenes;
DROP SEQUENCE IF EXISTS public.items_requisicion_id_seq;
DROP TABLE IF EXISTS public.items_requisicion;
DROP SEQUENCE IF EXISTS public.items_compra_id_seq;
...
DROP SEQUENCE IF EXISTS public.insumo_proveedor_id_seq;
DROP TABLE IF EXISTS public.insumo_proveedor;
DROP SEQUENCE IF EXISTS public.grados_id_seq;
DROP TABLE IF EXISTS public.grados;
DROP SEQUENCE IF EXISTS public.empleados_id_seq;
DROP TABLE IF EXISTS public.empleados;
DROP SEQUENCE IF EXISTS public.detalles_orden_id_seq;
DROP TABLE IF EXISTS public.detalles_orden;
DROP SEQUENCE IF EXISTS public.compras_id_seq;
DROP SEQUENCE IF EXISTS public.codigos_promocionales_id_seq;
DROP TABLE IF EXISTS public.codigos_promocionales;
DROP SEQUENCE IF EXISTS public.categorias_variantes_id_seq;
DROP TABLE IF EXISTS public.categorias_variantes;
DROP SEQUENCE IF EXISTS public.categoria_producto_tipo_variante_id_seq;
DROP TABLE IF EXISTS public.categoria_producto_tipo_variante;
DROP VIEW IF EXISTS public.analisis_precios_insumos;
DROP TABLE IF EXISTS public.proveedores;
DROP TABLE IF EXISTS public.items_compra;
DROP TABLE IF EXISTS public.insumos;
DROP TABLE IF EXISTS public.compras;
DROP FUNCTION IF EXISTS public.actualizar_inventario();
DROP FUNCTION IF EXISTS public.actualizar_estado_requisicion();
DROP FUNCTION IF EXISTS _heroku.validate_extension();
DROP FUNCTION IF EXISTS _heroku.postgis_after_create();
DROP FUNCTION IF EXISTS _heroku.grant_table_if_exists(alias_schemaname text, grants text, databaseowner text, alias_tablename text);
DROP FUNCTION IF EXISTS _heroku.extension_before_drop();
DROP FUNCTION IF EXISTS _heroku.drop_ext();
DROP FUNCTION IF EXISTS _heroku.create_ext();
DROP EXTENSION IF EXISTS pg_stat_statements;
DROP SCHEMA IF EXISTS _heroku;
--
-- Name: _heroku; Type: SCHEMA; Schema: -; Owner: root
--

CREATE SCHEMA _heroku;


ALTER SCHEMA _heroku OWNER TO root;
...
--
-- Name: create_ext(); Type: FUNCTION; Schema: _heroku; Owner: root
--
...
ALTER FUNCTION _heroku.create_ext() OWNER TO root;

--
-- Name: drop_ext(); Type: FUNCTION; Schema: _heroku; Owner: root
--
...
ALTER FUNCTION _heroku.drop_ext() OWNER TO root;

--
-- Name: extension_before_drop(); Type: FUNCTION; Schema: _heroku; Owner: root
--
...
ALTER FUNCTION _heroku.extension_before_drop() OWNER TO root;

--
-- Name: grant_table_if_exists(text, text, text, text); Type: FUNCTION; Schema: _heroku; Owner: root
--
...
ALTER FUNCTION _heroku.grant_table_if_exists(alias_schemaname text, grants text, databaseowner text, alias_tablename text) OWNER TO root;

--
-- Name: postgis_after_create(); Type: FUNCTION; Schema: _heroku; Owner: root
--
...
ALTER FUNCTION _heroku.postgis_after_create() OWNER TO root;

--
-- Name: validate_extension(); Type: FUNCTION; Schema: _heroku; Owner: root
--
...
ALTER FUNCTION _heroku.validate_extension() OWNER TO root;
...
--
-- Name: compras; Type: TABLE; Schema: public; Owner: root
--
...
ALTER TABLE public.compras OWNER TO root;

--
-- Name: insumos; Type: TABLE; Schema: public; Owner: root
--
...
ALTER TABLE public.insumos OWNER TO root;

--
-- Name: items_compra; Type: TABLE; Schema: public; Owner: root
--
...
ALTER TABLE public.items_compra OWNER TO root;

--
-- Name: proveedores; Type: TABLE; Schema: public; Owner: root
--
...
--
-- Name: analisis_precios_insumos; Type: VIEW; Schema: public; Owner: root
--
...
ALTER VIEW public.analisis_precios_insumos OWNER TO root;

--
-- Name: categoria_producto_tipo_variante; Type: TABLE; Schema: public; Owner: root
--
...
ALTER TABLE public.categoria_producto_tipo_variante OWNER TO root;

--
-- Name: categoria_producto_tipo_variante_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
--
-- Name: categorias_variantes; Type: TABLE; Schema: public; Owner: root
--
...
ALTER TABLE public.categorias_variantes OWNER TO root;

--
-- Name: categorias_variantes_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
--
-- Name: codigos_promocionales; Type: TABLE; Schema: public; Owner: root
--
...
ALTER TABLE public.codigos_promocionales OWNER TO root;

--
-- Name: codigos_promocionales_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
--
-- Name: compras_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
--
-- Name: grados; Type: TABLE; Schema: public; Owner: root
--
...
ALTER TABLE public.grados OWNER TO root;

--
-- Name: grados_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
--
-- Name: insumo_proveedor; Type: TABLE; Schema: public; Owner: root
--
...
ALTER TABLE public.insumo_proveedor OWNER TO root;

--
-- Name: insumo_proveedor_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
--
-- Name: insumos_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
--
-- Name: items_compra_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
--
-- Name: items_requisicion; Type: TABLE; Schema: public; Owner: root
--
...
ALTER TABLE public.items_requisicion OWNER TO root;

--
-- Name: items_requisicion_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
--
-- Name: pagos; Type: TABLE; Schema: public; Owner: root
--
...
ALTER TABLE public.pagos OWNER TO root;

--
-- Name: pagos_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
--
-- Name: preso_grado; Type: TABLE; Schema: public; Owner: root
--
...
ALTER TABLE public.preso_grado OWNER TO root;

--
-- Name: preso_grado_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
--
-- Name: producto_sabor; Type: TABLE; Schema: public; Owner: root
--
...
ALTER TABLE public.producto_sabor OWNER TO root;

--
-- Name: producto_sabor_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
--
-- Name: productos_sentencias; Type: TABLE; Schema: public; Owner: root
--
...
ALTER TABLE public.productos_sentencias OWNER TO root;

--
-- Name: productos_sentencias_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
--
-- Name: proveedores_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
--
-- Name: requisiciones; Type: TABLE; Schema: public; Owner: root
--
...
ALTER TABLE public.requisiciones OWNER TO root;

--
-- Name: requisiciones_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
--
-- Name: sabores; Type: TABLE; Schema: public; Owner: root
--
...
ALTER TABLE public.sabores OWNER TO root;

--
-- Name: sabores_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
--
-- Name: sentencias; Type: TABLE; Schema: public; Owner: root
--
...
ALTER TABLE public.sentencias OWNER TO root;

--
-- Name: sentencias_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
--
-- Data for Name: categoria_producto_tipo_variante; Type: TABLE DATA; Schema: public; Owner: root
--
...
--
-- Data for Name: categorias_variantes; Type: TABLE DATA; Schema: public; Owner: root
--
...
--
-- Data for Name: codigos_promocionales; Type: TABLE DATA; Schema: public; Owner: root
--
...
--
-- Data for Name: compras; Type: TABLE DATA; Schema: public; Owner: root
--
...
5	387	22	1	0.00	5	37	\N	\N	f	2025-07-02 19:49:32.525842	\N	\N	f	\N	2	f	1	\N	\N	f
6	387	5	1	0.00	5	\N	\N	\N	f	2025-07-02 19:49:32.525842	\N	\N	f	\N	2	f	1	\N	\N	f
7	387	34	1	0.00	5	\N	\N	12	f	2025-07-02 19:49:32.525842	\N	\N	f	\N	2	f	1	\N	\N	f
8	387	22	1	0.00	5	37	\N	\N	f	2025-07-02 19:49:32.525842	\N	\N	f	\N	4	f	2	\N	\N	f
9	387	31	1	0.00	5	\N	\N	12	f	2025-07-02 19:49:32.525842	\N	\N	f	\N	4	f	2	\N	\N	f
10	387	49	1	0.00	5	\N	\N	\N	f	2025-07-02 19:49:32.525842	\N	\N	f	\N	4	f	2	\N	\N	f
11	387	55	1	61.00	5	\N	\N	\N	f	2025-07-02 19:49:32.525842	\N	\N	f	\N	\N	f	\N	\N	\N	f
12	387	22	2	0.00	5	37	\N	\N	f	2025-07-02 19:49:32.525842	\N	\N	f	\N	3	f	3	\N	\N	f
13	387	5	2	0.00	5	\N	\N	\N	f	2025-07-02 19:49:32.525842	\N	\N	f	\N	3	f	3	\N	\N	f
131	425	34	1	135.00	2	11	\N	19	f	2025-07-25 21:47:30.513007	\N	\N	f	\N	\N	f	\N	\N	\N	f
...
133	426	22	1	0.00	2	37	\N	\N	f	2025-07-25 21:48:57.215966	\N	\N	f	\N	3	f	132	\N	\N	f
134	426	9	2	0.00	2	\N	\N	\N	f	2025-07-25 21:48:57.215966	\N	\N	f	\N	3	f	132	\N	\N	f
135	426	5	1	45.00	2	4	\N	\N	f	2025-07-25 21:48:57.215966	\N	21	f	\N	3	f	132	\N	\N	f
136	426	33	1	115.00	2	8	\N	17	f	2025-07-25 21:48:57.215966	\N	\N	f	\N	\N	f	\N	\N	\N	f
\.
...
--
-- Data for Name: grados; Type: TABLE DATA; Schema: public; Owner: root
--
...
--
-- Data for Name: items_compra; Type: TABLE DATA; Schema: public; Owner: root
--
...
--
-- Data for Name: items_requisicion; Type: TABLE DATA; Schema: public; Owner: root
--
...
--
-- Data for Name: pagos; Type: TABLE DATA; Schema: public; Owner: root
--
...
--
-- Data for Name: preso_grado; Type: TABLE DATA; Schema: public; Owner: root
--
...
--
-- Data for Name: producto_sabor; Type: TABLE DATA; Schema: public; Owner: root
--
...
--
-- Data for Name: productos_sentencias; Type: TABLE DATA; Schema: public; Owner: root
--
...
--
-- Data for Name: requisiciones; Type: TABLE DATA; Schema: public; Owner: root
--
...
--
-- Data for Name: sabores; Type: TABLE DATA; Schema: public; Owner: root
--
...
--
-- Data for Name: sentencias; Type: TABLE DATA; Schema: public; Owner: root
--
...
--
-- Name: categoria_producto_tipo_variante_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--
...
--
-- Name: categorias_variantes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--
...
--
-- Name: codigos_promocionales_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--
...
--
-- Name: compras_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--
...
SELECT pg_catalog.setval('public.detalles_orden_id_seq', 136, true);
...
--
-- Name: grados_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--
...
--
-- Name: items_compra_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--
...
--
-- Name: items_requisicion_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--
...
SELECT pg_catalog.setval('public.ordenes_orden_id_seq', 426, true);


--
-- Name: pagos_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--
...
--
-- Name: preso_grado_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--
...
--
-- Name: producto_sabor_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--
...
--
-- Name: productos_sentencias_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--
...
--
-- Name: requisiciones_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--
...
--
-- Name: sabores_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--
...
--
-- Name: sentencias_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--
...
--
-- Name: inventario_insumo_id_unidad_key; Type: INDEX; Schema: public; Owner: root
--
...
--
-- Name: proveedores_rfc_unique; Type: INDEX; Schema: public; Owner: root
--
...
--
-- Name: inventario trigger_actualizar_inventario; Type: TRIGGER; Schema: public; Owner: root
--
...
--
-- Name: extension_before_drop; Type: EVENT TRIGGER; Schema: -; Owner: root
--
...
ALTER EVENT TRIGGER extension_before_drop OWNER TO root;

--
-- Name: log_create_ext; Type: EVENT TRIGGER; Schema: -; Owner: root
--
...
ALTER EVENT TRIGGER log_create_ext OWNER TO root;

--
-- Name: log_drop_ext; Type: EVENT TRIGGER; Schema: -; Owner: root
--
...
ALTER EVENT TRIGGER log_drop_ext OWNER TO root;

--
-- Name: validate_extension; Type: EVENT TRIGGER; Schema: -; Owner: root
--
...
ALTER EVENT TRIGGER validate_extension OWNER TO root;
